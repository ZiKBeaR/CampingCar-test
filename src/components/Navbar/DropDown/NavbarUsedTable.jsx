...
const DropDownUsedTable = () => {
  const [dropdown, setDropdown] = useState(false)
  return (
    <>
    <div className={dropdown ? "DropDownUsedTableCon clicked" : "DropDownUsedTableCon"} onClick={() => setDropdown(!dropdown)}>
...
export default DropDownUsedTable